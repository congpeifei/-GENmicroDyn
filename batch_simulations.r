...
BGE.f <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_batch_model_BGE.csv") %>% filter(!is.nan(BGE))

##########################################################################################
## Taxonomic and Resource Variance Partitioning: BGE
...
# CUE
df_train <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn_Full/files_old/isolates_batch_model_train.csv")
df_train$yield <- 1- df_train$yield
df_test <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn_Full/files_old/isolates_batch_model_test.csv") 
...
## Flux variance
# high 
pchigh.f <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_batch_model_fluxes_high.csv")
...
# low
pclow.f <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_batch_model_fluxes_low.csv")
...
pcflux.f <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_batch_model_fluxes_low.csv")
...
# Niche breadth
Levin.f <- read.csv("/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_levins.csv") %>%
  replace(is.na(.), 0.0)
...
#write.csv(Levin.f.grouped, "/Users/glmarschmann/.julia/dev/GENmicroDyn/files/output/isolates_levins_grouped.csv")
